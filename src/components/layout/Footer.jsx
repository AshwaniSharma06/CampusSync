    ...
    <footer className="bg-surface-container-lowest border-t border-outline-variant/10 w-full py-section-gap mt-8 md:mt-section-gap">
      <div className="grid grid-cols-1 md:grid-cols-4 px-margin-mobile md:px-margin-desktop gap-8 md:gap-gutter max-w-container-max mx-auto">
        <div className="col-span-1 md:col-span-1 flex flex-col gap-4">
          <div className="font-display-md text-display-md text-primary text-4xl">CampusSync</div>
          <p className="text-on-surface-variant mt-2 md:mt-4 font-body-md text-sm md:text-body-md">
            © 2026 CampusSync Institutional. All rights reserved.
          </p>
        </div>
        <div className="col-span-1 md:col-span-3 grid grid-cols-2 md:grid-cols-3 gap-8">
          <div className="flex flex-col gap-3">
            <h5 className="text-white font-semibold font-label-sm uppercase tracking-wider mb-2">Legal</h5>
            <a
          ...
          <div className="flex flex-col gap-3">
            <h5 className="text-white font-semibold font-label-sm uppercase tracking-wider mb-2">Campus</h5>
            <a
          ...
          <div className="flex flex-col gap-3">
            <h5 className="text-white font-semibold font-label-sm uppercase tracking-wider mb-2">Community</h5>
            <a
